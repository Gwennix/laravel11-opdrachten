                ...
                <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                    <div class="sm:block sm:ml-6">
                        <div class="flex space-x-4">
                            ...
                            <a href="" class="text-gray-800 px-3 py-2 rounded-md text-sm font-medium" aria-current="page">Overzicht Product</a>
                            <a href="" class="text-gray-800 hover:text-teal-600 transition ease-in-out duration-500 px-3 py-2 rounded-md text-sm font-medium">Product Toevoegen</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <form id="form" class="shadow-md rounded-lg px-8 pt-6 pb-8 mb-4"
                    ...
                    <label class="block text-sm">
                        ...
                        focus:outline-none focus:shadow-outline-purple form-input"
                               name="name" value="" type="text" disabled/>
                    </label>
                    <label class="block text-sm">
                        ...
                        <textarea
                            ...
                            id="description" rows="7" disabled></textarea>
                    </label>
                    <label class="block text-sm">
                        <span class="text-gray-700">Price</span>
                        <input class="bg-gray-200  block rounded w-full p-2 mt-1 focus:border-purple-400
                        focus:outline-none focus:shadow-outline-purple form-input"
                               name="price" value="" type="text" disabled/>
                    </label>
                    <label class="block text-sm">
                        <span class="text-gray-700">Category</span>
                        <input class="bg-gray-200  block rounded w-full p-2 mt-1 focus:border-purple-400
                        focus:outline-none focus:shadow-outline-purple form-input"
                               name="category_id" value="" type="text" disabled/>
                    </label>
